    ...
    <div className="pt-24 pb-12 min-h-screen bg-muted/30">
      ...
      <div className="max-w-4xl mx-auto px-6">
        <header className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-10">
          <div>
            <h1 className="text-3xl font-black text-foreground" style={{ fontFamily: "Poppins, sans-serif" }}>Tableau de bord</h1>
            <p className="text-muted-foreground text-sm" style={{ fontFamily: "Poppins, sans-serif" }}>Suivi des réservations en temps réel</p>
          </div>
        ...
        <AnimatePresence>
          {permission === "granted" && (
            ...
            >
              ...
              <div className="text-xs text-blue-800 dark:text-blue-300 leading-relaxed" style={{ fontFamily: "Poppins, sans-serif" }}>
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-20 gap-4">
            ...
            <p className="text-sm text-muted-foreground animate-pulse" style={{ fontFamily: "Poppins, sans-serif" }}>
                  ...
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mt-2">
                    <div className="space-y-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="font-bold text-foreground" style={{ fontFamily: "Poppins, sans-serif" }}>{res.name}</div>
                    ...
                    <div className="flex flex-col items-end gap-3 pt-3 md:pt-0 border-t md:border-t-0 border-border">
                      <div className="flex items-center gap-1.5 text-primary font-black text-lg" style={{ fontFamily: "Poppins, sans-serif" }}>
                      ...
                      <div className="flex items-center gap-2">
                        {res.status !== "cancelled" ? (
                          ...
                          <div className="text-red-500 text-xs font-black uppercase" style={{ fontFamily: "Poppins, sans-serif" }}>
